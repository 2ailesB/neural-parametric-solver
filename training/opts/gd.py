...
class GD(Optimizer):
    """ Custom optimizer that performs gradient descent with Armijo line search.

    Args:
        params (iterable): iterable of parameters to optimize or dicts defining parameter groups.
        lr (float): learning rate.
        line_search_fn (str): line search function to use. Currently only 'armijo' is supported.
