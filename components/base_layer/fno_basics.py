...
""" Fourier Layers: taken from https://github.com/neuraloperator/physics_informed """
...
class SpectralConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, modes1, modes2):
        ...
        # print("self.modes1, self.modes2, self.in_channels, self.out_channels : ", self.modes1, self.modes2, self.in_channels, self.out_channels)
